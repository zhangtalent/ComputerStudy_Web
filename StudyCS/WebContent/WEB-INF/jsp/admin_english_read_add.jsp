...
<body>
    ...
    <ul class="layui-nav layui-bg-blue" >
	  ...
	  <li class="layui-nav-item  layui-this"><a href="">新增阅读</a></li>
	  <li class="layui-nav-item" ><a  href=""><i class="layui-icon">&#x1006;</i>退出</a></li>
	</ul>

 
	 <form class="layui-form layui-form-pane" style="margin-top:15px;width:90%;margin-left:5%;" method="post" action="read_add">
