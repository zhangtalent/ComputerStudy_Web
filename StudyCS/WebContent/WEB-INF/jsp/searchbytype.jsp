    ...
    <div id="showDiv" style="height:100%;">
			...
			<div style="margin-left:5%;">
				...
				<c:if test="${previous > -1}" var="canup" scope="session">
		   			<a href='?type=${type}&page=<c:out value="${previous}"/>'><button type="button" class="layui-btn layui-btn-sm layui-btn-primary"><i class="layui-icon"></i></button></a>
				</c:if>
				<c:if test="${not canup}">
				...
				<c:if test="${next > 0}" var="cannext" scope="session">
		   			<a href='?type=${type}&page=<c:out value="${next}"/>'><button type="button" class="layui-btn layui-btn-sm layui-btn-primary "><i class="layui-icon"></i></button></a>
				</c:if>
